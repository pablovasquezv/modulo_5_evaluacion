...
import com.vasquezsoftwaresolutions.evaluacion_modulo_5.databinding.FragmentProfilePageBinding
...
class ProfilePageFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.lilaProfile.setOnClickListener{
            findNavController().navigate(R.id.action_profilePageFragment_to_homePageFragment)
        }
    }
