...
import com.vasquezsoftwaresolutions.evaluacion_modulo_5.databinding.FragmentHomePageBinding
...
class HomePageFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnSendCash.setOnClickListener {
        ...
        binding.lilaTable.setOnClickListener{
